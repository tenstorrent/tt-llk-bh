...
@pytest.mark.parametrize("testname", ["multiple_tiles_combined"])
@pytest.mark.parametrize("mathop", ["elwadd"])
...
def test_all(format, mathop, testname, dest_acc):
    ...
    read_data = read_words_from_device("0,0", 0x1e000, word_count=read_words_cnt)
